...
type WidgetType = "menu" | "music" | "tictactoe";
                    ...
                    {activeWidget === "menu" ? (
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-white p-8 rounded-3xl border-4 border-border shadow-sticker flex flex-col items-center gap-4 hover:shadow-sticker-lg transition-all"
                            >
                                <div className="w-20 h-20 bg-accent-1/20 rounded-full flex items-center justify-center border-4 border-accent-1 text-4xl">
                                    🎵
                                </div>
                                <h3 className="text-xl font-bold text-foreground uppercase tracking-wide">Lo-Fi Player</h3>
                            </motion.button>
                            ...
                            <motion.button
                                ...
                                className="bg-white p-8 rounded-3xl border-4 border-border shadow-sticker flex flex-col items-center gap-4 hover:shadow-sticker-lg transition-all"
                            >
                                <div className="w-20 h-20 bg-accent-2/20 rounded-full flex items-center justify-center border-4 border-accent-2 text-4xl">
                                    ❌
                                </div>
                ...
                {activeWidget === "menu" && (
                    <motion.div variants={fadeInUp} className="w-full max-w-2xl mt-8">
                        <div className="bg-white p-6 rounded-2xl border-4 border-dashed border-border/40 text-center">
                            <p className="text-gray-500 font-bold">More mini-games (Snake, Memory Match) coming soon...</p>
                        </div>
                    </motion.div>
                )}
            </motion.div>
